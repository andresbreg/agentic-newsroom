...
import {
    ...
    Share2, Database, Video, FileText,
...
const Sources = () => {
    ...
    const handleSubmit = async (e) => {
        ...
        try {
            if (editingId) {
                await axios.put(`http://localhost:8000/api/sources/${editingId}`, payload);
                addToast('Fuente actualizada correctamente', 'success');
            } else {
                await axios.post('http://localhost:8000/api/sources', payload);
